<script lang="ts">
  ...
  import type { TerminalPreset, TerminalSessionInfo } from '@devframes/plugin-terminals/types'
  ...
  import { DOCKS_ACTIVE_STATE_KEY, PLUGIN_ID, PRESETS_STATE_KEY, SESSIONS_STATE_KEY } from '@devframes/plugin-terminals/constants'
