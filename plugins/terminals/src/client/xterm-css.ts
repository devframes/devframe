/**
 * xterm.js base stylesheet, inlined so the renderer is self-contained and
 * needs no build-time CSS import. Sourced from `@xterm/xterm/css/xterm.css`
 * (MIT, (c) the xterm.js authors).
 */
...
.xterm .composition-view {
    background: #000; color: #FFF; display: none; position: absolute;
...
.xterm .xterm-scrollable-element > .visible {
    opacity: 1; background: rgba(0,0,0,0); transition: opacity 100ms linear; z-index: 11;
}
