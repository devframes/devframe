import type {
  ...
  WriteOutcome,
  WriteRequest,
} from '@devframes/plugin-data-inspector/engine'
/**
...
import { runQuery, runQueryAtPath, skeletonOf, suggest as suggestQuery } from '@devframes/plugin-data-inspector/engine'
