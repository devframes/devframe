...
// returning @antfu/design's semantic shortcut classes, so this vanilla-DOM
// surface looks identical to the antfu Vue components. The `@unocss-include`
// marker makes UnoCSS emit the runtime-assembled class chains below.
