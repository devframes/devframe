...
export const Image: Story = {
  args: { asset: asset({}), class: 'h-40 w-40 rounded border border-base' },
}
...
export const TextNoContent: Story = {
  args: {
    asset: asset({ path: 'README.txt', type: 'text', publicPath: '/README.txt' }),
    class: 'h-40 w-40 rounded border border-base',
  },
}

export const Video: Story = {
  args: {
    asset: asset({ path: 'clip.mp4', type: 'video', publicPath: '' }),
    class: 'h-40 w-40 rounded border border-base',
  },
}
...
export const Audio: Story = {
  args: {
    asset: asset({ path: 'sound.mp3', type: 'audio', publicPath: '' }),
    class: 'h-40 w-40 rounded border border-base',
  },
}
...
export const Other: Story = {
  args: {
    asset: asset({ path: 'archive.zip', type: 'other', publicPath: '' }),
    class: 'h-40 w-40 rounded border border-base',
  },
}
