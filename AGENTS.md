...
The docs' canonical vocabulary lives in [`docs/content/1.guide/1.terms.md`](docs/content/1.guide/1.terms.md) - one name per concept. Every docs, README, and comment edit follows it:
