...
```sh
pnpm --filter hub-nitro dev
```

Open <http://localhost:3000> - the host page carries the floating dock via one script tag - or <http://localhost:3000/__devframes/> for the standalone hub UI.
