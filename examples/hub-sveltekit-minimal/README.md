...
Open <http://localhost:5173> — the host page carries the floating dock via one script tag — or <http://localhost:5173/__devframes/> for the standalone viewer.
