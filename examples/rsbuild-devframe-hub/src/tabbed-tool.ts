 ...
 * Mounted as a `subTabs` anchor (see `rsbuild.config.ts`), the hub's client host
...
export default defineDevframe({
  id: 'example:rsbuild-tabbed-tool',
  name: 'Tabbed Tool',
  version: pkg.version,
  ...
  basePath: '/__rsbuild-tabbed-tool/',
  cli: {
    distDir: fileURLToPath(new URL('../spa/rsbuild-tabbed-tool/', import.meta.url)),
  },
  async setup(rawCtx) {
