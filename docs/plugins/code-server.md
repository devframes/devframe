...
<figure class="screenshot">
  <img src="/screenshots/plugin-code-server-1.png" alt="Code Server" />
  <figcaption>Launcher before start</figcaption>
</figure>

<figure class="screenshot">
  <img src="/screenshots/plugin-code-server-2.png" alt="Code Server" />
  <figcaption>The embedded editor in the browser</figcaption>
</figure>
