...
# DF0061: Installed Assets Package Version Skew
...
With the node package declaring `version: '1.2.3'` and `@devframes/plugin-git-client@1.2.4` installed locally, the installed `1.2.4` assets are served and `DF0061` is reported.
...
A major-version mismatch is rejected instead — see [DF0060](./DF0060.md).
