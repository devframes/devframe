...
# DF0063: Remote Assets Materialization Failed
...
Running a static build on a machine without network access to the CDN provider — and without the assets package installed locally — throws `DF0063`.
