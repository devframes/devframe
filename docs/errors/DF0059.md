...
# DF0059: Remote Asset Fetch Failed
...
Opening the tool's UI with `cdn.jsdelivr.net` unreachable throws `DF0059` for each uncached file; HTML navigations respond with a styled error page carrying this code.
