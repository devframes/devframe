---
title: 'DF0027: Invalid Dump Configuration'
description: 'Function "{name}" with type "{type}" cannot have dump configuration. Only "static" and "query" types support dumps.'
---
