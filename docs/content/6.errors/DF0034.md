---
title: 'DF0034: Already-Namespaced Scoped Registration'
description: 'Scoped RPC registration for namespace "{namespace}" received an already-namespaced function name "{name}".'
---
