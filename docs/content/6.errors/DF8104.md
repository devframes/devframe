---
title: 'DF8104: Nested Dock Groups Unsupported'
description: 'Dock group "{id}" cannot itself belong to a group (nested groups are unsupported)'
---
...
- Remove `groupId` from the group entry so it stays a top-level dock-rail button.
