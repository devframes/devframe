---
title: 'DF0047: Agent Tool Wire-Name Collision'
description: 'Agent tool "{id}" is hidden from the MCP surface: its wire name "{name}" collides with the tool "{existing}".'
---
