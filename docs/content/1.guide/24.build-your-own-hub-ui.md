...
description: 'A hub viewer implements two contracts — the node-side ui slot and the browser-side context. @devframes/hub-ui is the reference.'
---

A hub viewer implements two contracts — the node-side `ui` slot and the browser-side context. `@devframes/hub-ui` is the reference.
