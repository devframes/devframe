...
A hub-aware client reads or subscribes via `rpc.client.register(...)`; the [client host](/guide/client-context) registers the `devframe:docks:activate` handler for you.
