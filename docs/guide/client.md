...
Derive a [scoped client](./scoped-context) for namespaced ids:
...
See [Scoped Context](./scoped-context#settings).
...
In a hub, a viewer reads this status from [`context.connection`](./client-context#the-client-context).
