...
export const alias = {
  ...
  '@devframes/plugin-code-server/client-script': p('code-server/src/client-script/client/index.ts'),
  ...
  '@devframes/plugin-data-inspector/client-script/page-script': p('data-inspector/src/client-script/page-script/index.ts'),
  '@devframes/plugin-data-inspector/client-script': p('data-inspector/src/client-script/client/index.ts'),
  ...
  '@devframes/plugin-inspect/client-script': p('inspect/src/client-script/client/index.ts'),
  ...
  '@devframes/plugin-og/client-script': p('og/src/client-script/client/index.ts'),
  ...
  '@devframes/plugin-a11y/client-script/page-script': p('a11y/src/client-script/page-script/index.ts'),
  '@devframes/plugin-a11y/client-script': p('a11y/src/client-script/client/index.ts'),
