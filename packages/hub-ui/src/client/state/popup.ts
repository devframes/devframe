...
const loadDockStandalone: () => Promise<new (props: { context: DocksContext }) => HTMLElement> = async () => {
...
async function openDockPopup(context: DocksContext): Promise<Window | null> {
